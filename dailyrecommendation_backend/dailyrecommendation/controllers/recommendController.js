...
const sequelize = require('../config/sequelize'); // your actual Sequelize instance
const UserRegistration = require('../models/UserRegistration');
const PatnerPreference = require('../models/PatnerPreference');
...
exports.generateDailyRecommendation = async (req, res) => {
  try {
    ...
    // 4. Fetch more profiles to filter unique firstNames
    const fetchedProfiles = await UserProfile.findAll({
      ...
      limit: 30 // Fetch more to increase chance of uniqueness
    });
    // 5. Filter unique first names
