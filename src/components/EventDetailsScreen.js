...
export default function DetailsScreen({ navigation }) {
  ...
  const invitations = [
    { id: '1', title: 'Vintage Garden Wedding', price: '₹1800', date: weekAgo, time: '4:00 PM', location: 'Namakkal', type: 'Paid', image: require('../assets/images/event1.jpg'), dressCode: 'Floral or Pastel', highlights: ['Live violin performance', 'Buffet', 'Photo booth', 'Lanterns', 'Dance floor'] },
    { id: '2', title: 'Beachside Vows Cafe', price: 'FREE', date: twoDaysAgo, time: '5:30 PM', location: 'Thrichy', type: 'Free', image: require('../assets/images/event1.jpg'), dressCode: 'White & Beige', highlights: ['Sunset vows', 'Seafood', 'Fire show', 'Bonfire', 'Drone footage'] },
    { id: '3', title: 'Today: Royal Banquet', price: '₹3000', date: today, time: '6:00 PM', location: 'Chennai', type: 'Invite', image: require('../assets/images/event1.jpg'), dressCode: 'Traditional', highlights: ['Live band', 'Gold decor', '7-course meal', 'Elephants', 'Cultural show'] },
    { id: '4', title: 'Sunset Terrace Ceremony', price: 'FREE', date: tomorrow, time: '7:00 PM', location: 'Coimbatore', type: 'Free', image: require('../assets/images/event1.jpg'), dressCode: 'Cocktail Attire', highlights: ['Rooftop vows', 'Champagne', 'City view', 'Live duo', 'Candles'] },
    { id: '5', title: 'Mehendi Fiesta Vibe', price: '₹1000', date: nextWeek, time: '3:00 PM', location: 'Madurai', type: 'Paid', image: require('../assets/images/event1.jpg'), dressCode: 'Colorful Ethnic', highlights: ['Henna', 'Dhol', 'Folk singers', 'Rangoli', 'Snacks'] },
  ];
      ...
      <ImageBackground source={item.image} style={styles.card} imageStyle={styles.cardBg}>
        <View style={styles.overlay}>
          ...
          <View style={styles.centerButtons}>
            <TouchableOpacity style={styles.registerButton} onPress={() => navigation.navigate('EventPaymentScreen', { event: { ...item, date: item.date.toISOString() } })}>
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        {/* <View style={styles.searchHeader}>
          <Text style={[styles.heading, { color: '#FF6B6B', marginLeft: 0, marginTop: 8 }]}>Wedding Invitation</Text>
